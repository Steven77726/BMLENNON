...
const MAIL_TO = parseRecipients(process.env.MAIL_TO || "ghighielsa@gmail.com,stevenohayon@icloud.com");
...
async function sendConfirmationEmail(text) {
  const subject = "Nouvelle confirmation — Bar Mitsvah Lennon";
